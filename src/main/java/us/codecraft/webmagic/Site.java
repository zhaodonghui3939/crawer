...
import us.codecraft.webmagic.utils.Config;
...
public class Site {
     ...
     */
    public Site(){
        String ipPool = config.getStringValue("ip.pool",null);
        ...
        if(ipPool != null){
           ...
           // this.httpProxyPool=new ProxyPool(proxyList,false);
            this.setHttpProxyPool(proxyList);
        }
    }
    ...
    public static void main(String[] args){
        Site site = Site.me();
        for(int i = 0; i< 100;i++){
            System.out.println(site.getHttpProxyFromPool());
        }
    }
